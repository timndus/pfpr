...
with open('12.log','r') as csvfile:
	plots = csv.reader(csvfile, delimiter='\n')
	for row in plots:
	    y1.append(float(row[0]))

with open('14.log','r') as csvfile:
    plots = csv.reader(csvfile, delimiter='\n')
    for row in plots:
        y2.append(float(row[0]))

with open('15.log','r') as csvfile:
    plots = csv.reader(csvfile, delimiter='\n')
    for row in plots:
...
with open('19.log','r') as csvfile:
    plots = csv.reader(csvfile, delimiter='\n')
    for row in plots:
        y5.append(float(row[0]))

with open('20.log','r') as csvfile:
    plots = csv.reader(csvfile, delimiter='\n')
    for row in plots:
        y6.append(float(row[0]))

with open('22.log','r') as csvfile:
	plots = csv.reader(csvfile, delimiter='\n')
	for row in plots:
	    y7.append(float(row[0]))

with open('23.log','r') as csvfile:
    plots = csv.reader(csvfile, delimiter='\n')
    for row in plots:
        y8.append(float(row[0]))

with open('25.log','r') as csvfile:
    plots = csv.reader(csvfile, delimiter='\n')
    for row in plots:
        y9.append(float(row[0]))

with open('27.log','r') as csvfile:
	plots = csv.reader(csvfile, delimiter='\n')
	for row in plots:
	    y10.append(float(row[0]))

with open('28.log','r') as csvfile:
    plots = csv.reader(csvfile, delimiter='\n')
    for row in plots:
        y11.append(float(row[0]))

with open('30.log','r') as csvfile:
	plots = csv.reader(csvfile, delimiter='\n')
	for row in plots:
	    y12.append(float(row[0]))

with open('32.log','r') as csvfile:
    plots = csv.reader(csvfile, delimiter='\n')
    for row in plots:
        y13.append(float(row[0]))

with open('33.log','r') as csvfile:
    plots = csv.reader(csvfile, delimiter='\n')
    for row in plots:
        y14.append(float(row[0]))

with open('35.log','r') as csvfile:
    plots = csv.reader(csvfile, delimiter='\n')
    for row in plots:
...
plt.title('')
plt.legend()
plt.savefig('exp4_energy_measurement_in_freq_changes_overall.png', dpi=500)
plt.show()
