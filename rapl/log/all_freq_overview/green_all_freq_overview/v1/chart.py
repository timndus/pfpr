...
with open('12_100.log','r') as csvfile:
	plots = csv.reader(csvfile, delimiter='\n')
	for row in plots:
	    y1.append(float(row[0]))

with open('14_100.log','r') as csvfile:
    plots = csv.reader(csvfile, delimiter='\n')
    for row in plots:
        y2.append(float(row[0]))

with open('15_100.log','r') as csvfile:
    plots = csv.reader(csvfile, delimiter='\n')
    for row in plots:
...
with open('20_100.log','r') as csvfile:
    plots = csv.reader(csvfile, delimiter='\n')
    for row in plots:
...
with open('35_100.log','r') as csvfile:
    plots = csv.reader(csvfile, delimiter='\n')
    for row in plots:
        y15.append(float(row[0]))

with open('41_100.log','r') as csvfile:
	plots = csv.reader(csvfile, delimiter='\n')
	for row in plots:
