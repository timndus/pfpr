...
if test -f dummy; then
	...
	export HWLOC_XMLFILE=/home/timndus/msc_project/mpich/mpich-3.2.1/test/mpi/impls/hydra/binding_reference/$topo.xml
	for bind_ in hwthread hwthread:2 hwthread:4 hwthread:8 core core:2 core:4 socket numa board ; do
		...
		/home/timndus/msc_project/mpich/mpich-install/bin/mpiexec -bind-to $bind_ -map-by $map_ -n 16 ./dummy | sort -k2n > actual.${topo}.${bind}.${map}.out
		diff /home/timndus/msc_project/mpich/mpich-3.2.1/test/mpi/impls/hydra/binding_reference/expected.${topo}.${bind}.${map}.out \
